...
--
-- Name: clientes; Type: TABLE; Schema: public; Owner: jorge; Tablespace: 
--
...
ALTER TABLE public.clientes OWNER TO jorge;

--
-- Name: oficinas; Type: TABLE; Schema: public; Owner: jorge; Tablespace: 
--
...
ALTER TABLE public.oficinas OWNER TO jorge;

--
-- Name: pedidos; Type: TABLE; Schema: public; Owner: jorge; Tablespace: 
--
...
ALTER TABLE public.pedidos OWNER TO jorge;

--
-- Name: productos; Type: TABLE; Schema: public; Owner: jorge; Tablespace: 
--
...
ALTER TABLE public.productos OWNER TO jorge;

--
-- Name: repventas; Type: TABLE; Schema: public; Owner: jorge; Tablespace: 
--
...
ALTER TABLE public.repventas OWNER TO jorge;
...
--
-- Name: clientes_pkey; Type: CONSTRAINT; Schema: public; Owner: jorge; Tablespace: 
--
...
--
-- Name: oficinas_pkey; Type: CONSTRAINT; Schema: public; Owner: jorge; Tablespace: 
--
...
--
-- Name: pedidos_pkey; Type: CONSTRAINT; Schema: public; Owner: jorge; Tablespace: 
--
...
--
-- Name: productos_pkey; Type: CONSTRAINT; Schema: public; Owner: jorge; Tablespace: 
--
...
--
-- Name: repventas_pkey; Type: CONSTRAINT; Schema: public; Owner: jorge; Tablespace: 
--
...
REVOKE ALL ON SCHEMA public FROM jorge;
...
REVOKE ALL ON TABLE clientes FROM jorge;
GRANT ALL ON TABLE clientes TO jorge;
...
REVOKE ALL ON TABLE oficinas FROM jorge;
GRANT ALL ON TABLE oficinas TO jorge;
...
REVOKE ALL ON TABLE pedidos FROM jorge;
GRANT ALL ON TABLE pedidos TO jorge;
...
REVOKE ALL ON TABLE productos FROM jorge;
GRANT ALL ON TABLE productos TO jorge;
...
REVOKE ALL ON TABLE repventas FROM jorge;
GRANT ALL ON TABLE repventas TO jorge;
